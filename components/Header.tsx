...
export default function Header() {
  ...
  return (
    <div className="absolute top-0 w-full">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={handleProfile}>
            <svg
              ...
              strokeWidth={1.5}
              stroke="currentColor"
              className="w-8 h-8 bg-gray-700 dark:bg-gray-200 stroke-gray-200 dark:stroke-gray-400 fill-gray-200 dark:fill-gray-400 rounded-full"
            >
      ...
      <div className={clsx("absolute border border-gray-400 mx-4 w-40 bg-white dark:bg-gray-700 px-4 py-2 text-right rounded transition-all duration-500", {"opacity-100 right-0" : isProfileActive, "opacity-0 -right-4": !isProfileActive})}>
        <button onClick={handleSignOut} className="font-bold text-gray-700 dark:text-gray-300 transition-colors duration-500">로그아웃</button>
      </div>
    </div>
  );
}