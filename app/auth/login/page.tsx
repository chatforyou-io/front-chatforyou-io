...
export default function Page() {
  return (
    <main className="flex flex-col items-center justify-center h-full bg-gray-200 dark:bg-gray-900 transition-colors duration-500">
      <Header />
      <div className="flex flex-col items-center justify-center gap-20 border-x border-gray-400 mt-12 p-4 w-96 h-full bg-white dark:bg-gray-700">
        ...
        <div className="flex flex-col justify-center items-center gap-8 w-full mt-4">
          <div className="relative flex justify-center border-b border-gray-700 dark:border-gray-300 w-full">
            <p className="absolute -bottom-2.5 px-2 bg-white dark:bg-gray-700 text-gray-700 dark:text-gray-300 text-sm">또는 다음으로 로그인</p>
          </div>
