  ...
  return (
    <Link href={`/chatroom/view/${chatroom.sessionId}`} className="px-4 py-6 w-80 h-72 space-y-4 bg-white rounded-xl">
      <div className="flex gap-4">
        <Image src="/front/images/icon-exclamation-circle.svg" alt="room" width={20} height={20} />
      ...
      <div className="flex justify-between gap-4 border-t pt-6">
        <div className='flex gap-2'>
          <Image src="/front/images/icon-exclamation-circle.svg" alt="room" width={40} height={40} />
          <div>
