    ...
    <div className="px-4 py-6 w-80 h-52 space-y-4 bg-white rounded-xl">
      ...
      <div className="flex justify-between gap-4 border-t pt-6">
        <div className='flex space-x-2 w-full'>
          <Image src={`${basePath}/images/icon-user.svg`} alt="room" width={40} height={40} className="w-10 h-10 border-2 border-gray-700 rounded-full" />
          <div>
        ...
        <div className='flex-center'>
          <Image src={`${basePath}/images/icons/star.svg`} alt="room" width={32} height={32} className="w-8 h-8 text-gray-700 rounded-full" />
        </div>
      </div>
    </div>
  );
